  ...
  if (!is_initialized_) {
    ...
    */
    ...
    if (measurement_pack.sensor_type_ == MeasurementPackage::RADAR) {
      ...
      */
     double rho = measurment_pack.raw_measurements[0];
      double phi = measurment_pack.raw_measurements[1];
      double rhodot = measurment_pack.raw_measurements[2];
      ...
      Initialize state.
      */
      ekf_.x_ = measurment_pack.raw_measurements[0], measurment_pack.raw_measurements[1], 0, 0;
